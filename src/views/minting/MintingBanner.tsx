...
const MintingBanner: React.FC = () => {
  ...
  return (
    <section className="w-full minting-banner min-h-screen mx-autorelative text-white flex md:items-center justify-center mt-20 xl:mt-0">
      <div
      ...
      />
      <div
        className="h-auto mx-auto bg-[url('/assets/minting/solidier_mobile.png')] xl:bg-none bg-no-repeat bg-contain bg-center max-w-screen-2xl"
        style={{ transform: 'rotate(-180deg)' }}
      >
        <div className="flex items-center pt-96 xl:pt-16">
          ...
          <div className="flex flex-col items-center w-full xl:w-[50%]">
            <div className="xl:flex xl:flex-col xl:gap-4 w-[80%] mx-auto hidden">
            ...
            <div className="hidden sm:flex justify-center gap-4 md:gap-9 mt-12">
              <img
            ...
            <div className="flex flex-col xl:hidden gap-4 my-12 py-5 w-4/5">
              <img src="/hero/text2.png" alt="text2" />
