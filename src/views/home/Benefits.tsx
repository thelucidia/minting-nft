...
const benefitList = [
  ...
  '50% discount on the first Lucidia merch',
    ...
    <div className="w-full bg-[url('/assets/benefits/benefits_back_mobile.png')] xl:bg-[url('/assets/benefits/benefits_back_desktop.png')] bg-contain md:bg-cover bg-repeat md:bg-no-repeat">
      <section className="flex flex-col mx-auto py-20 px-12 max-w-screen-xl ">
        <div className="flex items-center w-full my-12">
          <h1 className="w-full sm:w-2/3 text-3xl md:text-5xl 2xl:text-[60px]  font-primary max-w-[800px] 2xl:leading-[5.5rem] uppercase font-semibold md:block text-transparent bg-clip-text bg-gradient-to-r from-[#0ED4FF] via-[#9586FF] to-[#FFFFFF]">
            ENJOY THE BENEFITS OF OWNING A LUCIDIA PASSPORT
          </h1>
        </div>
